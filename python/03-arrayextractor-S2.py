...
2023-01-05 MY added snow flag for cloud masking
...
FILTER_OUT_SEN2COR_CLASSES = [0, 1, 3, 8, 9, 10, 11] # No data, Cloud Shadows + Clouds medium+high probability + Cirrus + Snow
#[0, 1, 3, 8, 9, 10]
