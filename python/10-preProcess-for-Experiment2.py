...
Preprocess and save datasets for experiment 2:
"Is temporal fusion of S2 observations over the sensing period is superior to series of observations?"

RUN:

# S1S2 3D no duplicates for TCN:
python ../python/10-preProcess-for-Experiment2.py -i /Users/myliheik/Documents/myVEGCOVER/vegcover2023/cloudless/dataStack-insitu/ard-S1-S2-3D-noDuplicates_2020-2021-2022-2023.npz \
-o /Users/myliheik/Documents/myVEGCOVER/vegcover2023/results/experiment2 \
-c 12340


# S2 3D for TCN:
python ../python/10-preProcess-for-Experiment2.py -i /Users/myliheik/Documents/myVEGCOVER/vegcover2023/cloudless/dataStack-insitu/ard-S2-3D_2020-2021-2022-2023.npz \
-o /Users/myliheik/Documents/myVEGCOVER/vegcover2023/results/experiment2 \
-c 12340


# S2 3D, duplicates (due to overlapping tiles) removed, for TCN:
python ../python/10-preProcess-for-Experiment2.py -i /Users/myliheik/Documents/myVEGCOVER/vegcover2023/cloudless/dataStack-insitu/ard-S2-3D-noDuplicates_2020-2021-2022-2023.npz \
-o /Users/myliheik/Documents/myVEGCOVER/vegcover2023/results/experiment2 \
-c 12340

# S1S2 Fusion MLP:
python ../python/10-preProcess-for-Experiment2.py -i /Users/myliheik/Documents/myVEGCOVER/vegcover2023/cloudless/fused-insitu/ard-S1-S2-2D_2020-2021-2022-2023.npz \
-o /Users/myliheik/Documents/myVEGCOVER/vegcover2023/results/experiment2 \
-c 12340

# S2 Fusion MLP:
python ../python/10-preProcess-for-Experiment2.py -i /Users/myliheik/Documents/myVEGCOVER/vegcover2023/cloudless/fused-insitu/normalized3D_2020-2021-2022-2023.npz \
-o /Users/myliheik/Documents/myVEGCOVER/vegcover2023/results/experiment2 \
-c 12340
...
def main(args):
    ...
    try:
        ...
        print(f'\n10-preProcess-for-Experiment2.py')
